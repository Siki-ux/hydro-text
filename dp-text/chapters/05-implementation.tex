...
The three platform components are described in turn below. Section~\ref{sec:impl-tsm} covers the
adaptations to \texttt{tsm-orchestration}. The \texttt{water-dp} backend and frontend are treated in
Sections~\ref{sec:impl-backend} and~\ref{sec:impl-frontend}. Section~\ref{sec:impl-deploy}
...
To deploy \texttt{water-dp} alongside TSM without touching the upstream Compose file, a
