...
Seven view files replace the original set, mapping the local \texttt{thing},
...
JSONB properties, adding a \texttt{dataSource: local} marker to observations, and deriving
