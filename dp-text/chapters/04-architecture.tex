...
\begin{figure}[p]
  ...
  \begin{tikzpicture}[
    ...
    \node[font=\small\bfseries, anchor=south west] at (wdp.north west) {Water Data Platform (application layer) --- \emph{new}};
    ...
    \node[font=\small\bfseries, anchor=south west] at (tsm.north west)
      {tsm-orchestration (infrastructure layer) --- \emph{inherited \& modified}};
    ...
    %% ── Shared Data Layer ──
    \node[layer, label={[font=\small\bfseries]north:Shared Data Layer --- \emph{inherited (upstream)}}]
