...
The platform described in later chapters builds on several technologies and prior systems.
...
\begin{description}
  ...
  \item[thing-setup] Subscribes to the configdb-update notification topic. Orchestrates six
    ...
    (4)~provisions a Grafana dashboard and organization;
  ...
  \item[sync-extapi] Subscribes to synchronization trigger messages. Supports multiple built-in
  ...
  \item[sync-extsftp] Subscribes to synchronization trigger messages. Connects to external SFTP
